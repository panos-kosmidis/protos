...
#argb{color:#1affeeaa}';
      var expected2 = '((function(){var a,b,c,d,e,f,g,h,i=Array.prototype.slice;e=42,f=!0,f&&(e=-42),h=function(a){return \
a*a},b=[1,2,3,4,5],c={root:Math.sqrt,square:h,cube:function(a){return a*h(a)}},g=function(){var a,b;return b=arguments[0],\
a=2<=arguments.length?i.call(arguments,1):[],print(b,a)},typeof elvis!="undefined"&&elvis!==null&&alert("I knew it!"),\
a=function(){var a,e,f;f=[];for(a=0,e=b.length;a<e;a++)d=b[a],f.push(c.cube(d));return f}()})).call(this),function(){var \
a,b,c,d;d=["do","re","mi","fa","so"],c={Jagger:"Rock",Elvis:"Roll"},a=[1,0,1,0,0,1,1,1,0],b={brother:{name:"Max",age:11},\
