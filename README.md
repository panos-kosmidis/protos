...
- Built-in Controller authentication (optional, can also be fully handled by Controller Filters)
- Controller Filters: Restrict access to your controllers using your own callbaks
...
These are the features in the framework's core. The next section shows you the features available on 
...
The drivers provide you with methods that abstract common database operations in the database in question.
...
Models support validation and automatic typecasting based on the property types.
...
Will expose the following views:
