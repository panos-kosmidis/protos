...
Controller.prototype.prepare = function(app) {
  ...
  // Only for enumeration purposes
  this.authRequired = (typeof this.constructor.authRequired == 'undefined')
  ? Controller.prototype.authRequired
  : this.constructor.authRequired;
            ...
            cb = function() {
              if (app.supports.session && route.authRequired) {
                if (req.__session.user != null) {
                  route.callback.call(self, req, res, req.__params);
                } else {
