...
function CoreJS(noserver) {
  ...
  var Utility = require('./utility'),
      skipFromLibDir = ['request.js', 'response.js', 'framework.js', 'addons', 'drivers', 'engines', 'storage'];
  ...
  // Storage
  this.util.getFiles(this.path + '/lib/storage/' , function(file) {
    var key = file.replace(self.regex.jsFile, '');
    self.storage[key] = require(self.path + '/lib/storage/' + file);
  });
