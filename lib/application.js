...
function Application(domain, path) {
  ...
  corejs.util.requireAllTo(this.mvcpath + "helpers", this.helpers, function(Ctor) {
    // MainHelper inherits from Helper
    if (Ctor.name == 'MainHelper') util.inherits(Ctor, corejs.lib.helper);
  ...
  // TODO: Add inherited Helper methods as `$method` partial
...
Application.prototype.use = function(middleware, options) {
  ...
  this.debug(util.format("Loaded %s", middleware));
