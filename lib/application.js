...
function Application(domain, path) {
  ...
  var instance, helperCtor = framework.lib.helper;
  ...
  // Get models/
  var model, name, modelCtor = framework.lib.model;
  ...
  var controllerCtor = framework.lib.controller;
...
require('util').inherits("+ func.name +", framework.lib.controller);\n\n\
